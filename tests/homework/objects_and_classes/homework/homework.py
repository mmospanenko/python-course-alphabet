...
class Cesar:
    ...
    def add_car(self, car, garage=None):
        ...
        if not count:
            return f'Sorry all the places are taken'
...
class Garage:
    ...
    def __init__(self, town, places: int, cars=0, owner=None):
    ...
    def add(self, car):
        ...
        if car_in_garage:
            return f'The car {car.producer} is already in the garage '\
                f'{self.town}'
        return f'Sorry garage count is full (places={self.places}, '\
